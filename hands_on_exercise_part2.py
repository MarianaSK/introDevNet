...
def create_fortune_cookie_message(how_many_lucky_numbers: int) -> str:
    ...
    # cookie's message.
    luckyNumbers=generate_lucky_numbers(how_many_lucky_numbers)
    fortuneMessage=generate_fortune()
    #cookieMessage=[luckyNumbers,fortuneMessage]
    return "Fortune: {fortuneMessage} \nLucky Number: {luckyNumbers}".format(fortuneMessage=fortuneMessage, luckyNumbers=luckyNumbers)
...
def main():
    ...
    #generate_lucky_numbers(how_many=6)
    ...
    qty_lucky_numbers = int(qty_lucky_numbers)

    # Create and display their Fortune
    fortune_cookie_message = create_fortune_cookie_message(how_many_lucky_numbers=qty_lucky_numbers)
